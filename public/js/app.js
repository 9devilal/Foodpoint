...
/* harmony import */ var _worker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./worker */ "./resources/js/worker.js");
...
var guestCart = document.querySelectorAll('.add-to-guest');
...
var abortCartAdd = function abortCartAdd() {
  new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
    type: "warning",
    timeout: 1000,
...
guestCart.forEach(function (btn) {
...
var updateStatus = function updateStatus(order) {
  allStatus.forEach(function (stat) {
    stat.classList.remove('done');
    stat.classList.remove('current');
  });
  var stepCompleted = true;
  allStatus.forEach(function (currStatus) {
...
var workerPath = window.location.pathname; // console.log('here it is \n' + workerPath)

if (workerPath.includes('worker')) {
  Object(_worker__WEBPACK_IMPORTED_MODULE_3__["InitWorker"])(socket);
...
function InitWorker(socket) {
  ...
  var orders = [];
  var markup; // console.log('here\n' + orders)

  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/worker/orders', {
    headers: {
...
__webpack_require__(/*! /home/d_evilal/Foodpoint/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/d_evilal/Foodpoint/resources/scss/app.scss */"./resources/scss/app.scss");
